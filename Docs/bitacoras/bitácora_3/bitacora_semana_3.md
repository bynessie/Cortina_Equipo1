...
Por lo cual, en base a nuestra experiencia, creamos el código. Aunque actualmente nos falta pulirlo bastante.

## Conexión con el curso
**Concepto de MR2022:** Actuadores industriales - Actuadores electricos.
Al tener que realizar el sistema de subida y bajada en el sistema de la cortina tubimos que entender que eran los actuadores y posteriormente implementar algunos en nuestro sistema para que este lograra funcionar (Motor eléctrico)
...
## Reflexión grupal
A diferencia de otras practicas, esta vez surgio un inconveniente el cual aunque no nos permitio terminar de forma satisfactoria nuestra practica, nos dio la oportunidad de aprender el como funcionaba el código con el cual estabamos trabajando, y gracias a esto vamos a poder mejorar este para lograr que funcione de una forma más efectiva y segura.
Aparte de ello, fue grata la experiencia de montar el sistema, entender para que servian y como funcionaban los interlocks y sobretodo de haber visitado la fabrica de American axle
